...
export const members: Member[] = [
  ...
  export const advisors: Member[] = [
    ...
    new Member(
      ...
      'A research program manager in A*STAR, managed more than $10million in research grants. Appointed by Singapore government to lead & develop standards for nationwide fiber network.','adv'),
    new Member(
