...
export const members: Member[] = [
    new Member(
      ...
      'Serial entrepreneur, experience in raising multi-million funding & grew one of his startups to a million dollar generating business. His BPaaS was picked by SGInnovate (government) as the pioneer batch of incubatees. ',
      'team'
    ),
    new Member(
      ...
      'An Ex-Co member of the Singapore Fintech Association heading the Talent Committee, he is also active public speaker for Blockchain & Fintech events. A blockchain consultant for major corps & gov, and worked with C-Suite Exe on various strategic partnerships.',
      'team'
    ),
    new Member(
      ...
      'Over 16 years in Financial Services Application Development and IT Management. Seasoned in multi-million digital transformation projects. Group CIO at UniCredit Bank; Tech Advisor in blockchain, IoT and FinTech startups.',
      'team'
    ),
    new Member(
      ...
      'Over 20 years in software development and technology innovation. Implemented a blockchain business application in production using HyperLedger Fabric V1.0, the first in the region and the world.',
      'team'
    ),
    new Member(
      ...
      'Over 10 years of specialised in strategy and design. He creates better user interface and user experience in design to generate better marketing and sales to the clients such as UOB, OCBC, DBS, Standard Chartered Bank.',
      'team'
    ),
    new Member(
      ...
      'Successfully delivered multiple web and mobile applications for big clients from financial institutions and banks. A strong advocate of Agile Development and a Blockchain Enthusiast.',
      'team'
    ),
    new Member(
      ...
      'Senior UX technology consultant with experience in executing multi-million mobile/web engagement with global clients from banking, retail and manufacturing, a Blockchain Enthusiast.',
      'team'
    ),
  ]
  ...
  export const advisors: Member[] = [
    new Member(
      ...
      'The founder director of Global IP Southeast Asia Pte Ltd, an IP rights consultancy firm with offices across Asia. He is also actively involved in venture / angel capital investment in IP based companies.',
      'adv'
    ),
    new Member(
      ...
      'A conference speaker & seasoned entrepreneur; founded several successful companies including a multi-million financial tech company which was acquired. He held IP related key positions at government bodies in Singapore.',
      'adv'
    ),
    new Member(
    ...
    new Member(
      ...
      'A research program manager in A*STAR, managed more than $10million in research grants. Appointed by the Singapore government to lead & develop standards for Singapore’s nationwide fiber network.','adv'),
    new Member(
    ...
    new Member(
      ...
      'A professor in University & Independent Director for Nanoplus, Inc., expert in finance, investment, corporate governance and robotic trading. He worked closely with Ministry of Science & Technology (Taiwan) for years.',
      'adv'
      ),
    new Member
      ...
      'An international lawyer, advised more than 10 ICO projects globally in international law, advising & reviewing blockchain regulations in various jurisdictions. With vast Chinese investor network, he is one of most sought after ICO advisors in North Asia.',
      'adv'
    ),
    new Member(
