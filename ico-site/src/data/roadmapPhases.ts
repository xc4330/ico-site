...
export const techPhases: Phase[] = [
  ...
  export const bizPhases: Phase[] = [
    ...
    new Phase('3','','Oct 2017','Received initial Seed investment. Completed Whitepaper & soft marketing launch. Early bird token sales in December. Government Polytechnic in Singapore in discussion of a 5-campus implementation of our solution and co create a curriculum','current', false, false),
