...
export const stages: Stage[] = [
    ...
    new Stage(2,'bonus2','Early-bird Premium Bonus','date2','time','ongoing'),
    new Stage(3,'bonus3','Early-bird Premium Bonus','date3','time','new'),
    new Stage(4,'bonus4','Pre-sales Additional Bonus','date4','time','new'),
    new Stage(5,'bonus5','Pre-sales Additional Bonus','date5','time','new'),
    new Stage(6,'bonus6','Official Sales','date6','time','new'),
  ]