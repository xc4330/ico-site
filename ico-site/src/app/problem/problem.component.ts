...
export class ProblemComponent implements OnInit {
  problems: Bubble[] = [
    ...
    new Bubble('What use cases?','../../assets/icons/ProblemStatement02.png','Companies have difficulties understanding the use cases that apply to their industry ','problem'),
